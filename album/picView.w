...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" onParamsReceive="modelParamsReceive"><div component="$UI/system/components/justep/data/data" autoLoad="true" xid="data_thread" idColumn="tid" limit="-1" isTree="false"><column name="tid" type="Integer" xid="xid1"></column>
...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <div component="$UI/system/components/justep/list/list" class="x-list" xid="list_date" data="data_date" dataItemAlias='data_dateRow'>
   ...
   <ul class="x-list-template" xid="listTemplateUl_pic" componentname="$UI/system/components/justep/list/list#listTemplateUl" id="undefined_listTemplateUl1">
    <li xid="li2" class="col-xs-4 tb-listBox">
   <div xid="div5">
