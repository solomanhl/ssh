...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   ...
   <div class="x-panel-content" xid="content1"><div xid="div1"><label xid="label2"><![CDATA[站点统计信息]]></label></div>
  <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row1">
   ...
   <div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output_tiezi" bind-ref='$model.data_info.ref("posts")'></div></div></div></div>
  <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row2">
   ...
   <div class="col col-xs-4" xid="col10"></div></div></div>
